...
const CampDetails = () => {
    ...
    return (
        <motion.div
            className="w-[90%] xl:w-[85%] mx-auto pt-36 pb-24"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
            ...
            >
                ...
                >
                    <h2 className="text-2xl sm:text-3xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold text-accent mb-6">{camp.campName}</h2>
                    <ul className="space-y-4 text-sm sm:text-base lg:text-sm xl:text-base 2xl:text-lg text-gray-400">
                        <li className="flex items-center gap-3">
                            <FaCalendarAlt className="text-accent" />
                            <span><strong>Date:</strong> {new Date(camp.dateAndTime).toLocaleString()}</span>
                        </li>
                        <li className="flex items-center gap-3">
                        ...
                        <li className="flex items-center gap-3">
                            ...
                            <span><strong>Camp Fees:</strong> ${camp.campFees}</span>
                        </li>
                        <li className="flex items-center gap-3">
                            <FaUserMd className="text-accent" />
                            <span><strong>Healthcare Professional:</strong> {camp.healthcareProfessional}</span>
                        </li>
                        <li className="flex items-center gap-3">
                            <FaUsers className="text-accent" />
                            <span><strong>Participants:</strong> {camp.participantCount} people</span>
                        </li>
                    </ul>
                    ...
                    <div className="mt-8">
                        ...
                        <p className="text-sm sm:text-base lg:text-sm xl:text-base 2xl:text-lg text-gray-400 leading-6">{camp.description}</p>
                    </div>
