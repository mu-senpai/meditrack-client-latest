...
const NewsletterSection = () => {
  ...
  return (
    <section
      className="w-full pt-10 pb-6 sm:pt-14 sm:pb-9 md:pt-18 md:pb-14 xl:pt-20 xl:pb-18 2xl:pt-24 2xl:pb-22"
      style={{
    ...
    >
      <motion.section
        ...
        className="w-[90%] min-[1920px]:max-w-[108rem] mx-auto rounded-lg bg-[#00d3bb]/[0.3] backdrop-blur-md shadow-md border border-[#00d3bb] p-4 sm:p-5 xl:p-6"
      >
        <section className="w-full bg-[#e3f8f6] border border-[#00d3bb] text-[#00d3bb] p-8 rounded-xl text-center">
