...
import { FiClipboard, FiShield, FiGlobe } from "react-icons/fi";
        ...
        <section className="w-[90%] mx-auto pt-10 sm:pt-14 md:pt-18 xl:pt-20 2xl:pt-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 mt-8 sm:mt-10 xl:mt-12">
                ...
                >
                    ...
                    <h3 className="text-lg sm:text-xl xl:text-2xl font-semibold text-accent mb-2 xl:mb-3">Easy Management</h3>
                    <p className="text-xs/normal sm:text-sm/normal xl:text-base/normal text-gray-400">
                        Organize and manage medical camps efficiently with our user-friendly dashboard.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <h3 className="text-lg sm:text-xl xl:text-2xl font-semibold text-accent mb-2 xl:mb-3">Secure & Reliable</h3>
                    <p className="text-xs/normal sm:text-sm/normal xl:text-base/normal text-gray-400">
                        Your data is protected with top-level security for a safe experience.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <h3 className="text-lg sm:text-xl xl:text-2xl font-semibold text-accent mb-2 xl:mb-3">Global Reach</h3>
                    <p className="text-xs/normal sm:text-sm/normal xl:text-base/normal text-gray-400">
                        Connect with healthcare professionals worldwide and expand your impact.
                    </p>
                </motion.div>
            </div>
        </section>
