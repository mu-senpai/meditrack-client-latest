...
const doctors = [
  {
    ...
    image: "/dr-james-anderson.webp",
  },
  {
    name: "Dr. Olivia Martinez",
    specialty: "Pediatrics",
    image: "/dr-olivia.webp",
  },
  {
    name: "Dr. Ethan Brown",
        ...
        {doctors.map((doctor, index) => (
          ...
          >
            <img
              src={doctor.image}
              alt={doctor.name}
              className="w-[75%] mx-auto rounded-full mb-5"
            />
            <h3 className="text-xl lg:text-2xl xl:text-xl 2xl:text-2xl font-semibold text-accent">
              {doctor.name}
            </h3>
            <p className="text-base lg:text-lg xl:text-base 2xl:text-lg text-gray-400">
              {doctor.specialty}
            </p>
          </motion.div>
        ))}
