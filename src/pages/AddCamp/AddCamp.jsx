...
const AddCamp = () => {
    ...
    return (
        <motion.div
            className="flex justify-center items-center min-h-screen py-14 sm:py-20 md:py-28 bg-base-200"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
            ...
            >
                <h2 className="text-2xl sm:text-3xl xl:text-4xl font-bold text-center mb-8 text-accent">Add a Camp</h2>
                <form
                ...
                >
                    ...
                    >
                        <div className='w-full flex gap-4 items-center'>
                            ...
                            />
                            <p className='text-gray-400 text-xs sm:text-base inline-flex gap-2'>DD/MM/YYYY <span className='hidden sm:flex lg:hidden xl:flex'>12:00</span></p>
                        </div>
                    </motion.div>
